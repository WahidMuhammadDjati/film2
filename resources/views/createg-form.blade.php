...
<div x-data="{ open: false }">
    <button @click="open = true" class="bg-blue-500 text-white px-4 py-2 rounded">Tambah Genre</button>

<div x-show="open" class="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50">
    <div class="bg-white p-6 rounded-lg w-[500px] h-[500px] shadow-lg">
        <h2 class="text-lg font-semibold mb-4 text-center">Tambah Genre</h2>
        <form action="{{ route('genre.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="grid grid-cols-2 gap-4">
                <div>
                    ...
                    <input type="text" name="nama_genre" class="w-full border p-2 rounded-md" required>
                </div>
            </div>
