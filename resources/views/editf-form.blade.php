...
<div     class="bg-white p-6 rounded-lg shadow-lg w-full max-w-3xl mx-auto">
    ...
    <form action="{{ route('films.update', $film->id) }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="mb-3 mt-4">
            ...
            <textarea name="deskripsi" class="w-full border p-2 rounded-md" rows="3" required>{{ $film->deskripsi }}</textarea>
        </div>
        <div class="flex justify-between">
            <a href="{{ route('admin.dashboard') }}" class="bg-gray-500 text-white px-4 py-2 rounded-md">Batalkan</a>
